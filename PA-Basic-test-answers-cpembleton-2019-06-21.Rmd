...
First, the data should include only that with population data, and include an identifer differentiating the states with and without the policy.
```{r}
Births_pop <- Births %>% 
...
## 5.2 Estimating the impact of the 2008 policy on the fertility rates
...
Which gives a residual standard error of 7.344, indicating that the treatment *increased* by 7.344. 
